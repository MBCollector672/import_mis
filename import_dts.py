...
from .dts_util import arm_location_curves, arm_rotation_curves, arm_scale_curves, arm_vis_curves, default_materials, resolve_texture, get_rgb_colors, fail, ob_location_curves, ob_scale_curves, ob_rotation_curves, ob_vis_curves, ob_rotation_data, evaluate_all
        ...
        for seq in shape.sequences:
            ...
            for mattersIndex, node in enumerate(nodesRotation):
                ...
                for frameIndex in range(seq.numKeyframes):
                    ...
                    if use_armature:
                        if ob.parent is not None:
                            if ob.name == "Bip01 Pelvis#2" and frameIndex == 5:
                                print(f"rot: {rot}")
